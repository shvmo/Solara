(function () {
    const translations = {
        ...
        "网易云的接口修复好了，酷我还是不行，周杰伦用JOOX下载和听是可以的，我真厉害": "Made by Wet Dream Boy. Free API from GD Music (music.gdstudio.xyz). For educational purposes only, please support official releases!",
